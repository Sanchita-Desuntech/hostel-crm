...
<head>
  ...
  <script src="<?php echo base_url() ?>themes/admin/js/jquery-ui.js"></script>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
              ...
              <li class="sub-menu dcjq-parent-li">
                ...
                <ul class="sub" style="display: block;">
                  <li><a href="<?= base_url('admin/customer') ?>"><i class="fa fa-circle-o" aria-hidden="true"></i> Customer </a></li>
                  <!--          <li><a href="https://ehostingguru.com/stage/valogical/admin/payment"><i class="fa fa-circle-o" aria-hidden="true"></i>Complete Payment </a></li>-->
                </ul>
              </li>
              <li class="sub-menu dcjq-parent-li">
                <a href="javascript:;" class="dcjq-parent">
                  <i class="fa fa-users" aria-hidden="true"></i> <span>Profile Management</span>
                  <i class="fa fa-angle-down iconright" aria-hidden="true"></i>
                  <span class="dcjq-icon"></span></a>
              ...
              <li class="sub-menu dcjq-parent-li">
                <a href="javascript:;" class="dcjq-parent">
                  ...
                  <span class="dcjq-icon"></span></a>
                <ul class="sub" style="display: none;">
                  <li><a href="<?= base_url('admin/service') ?>"><i class="fa fa-circle-o" aria-hidden="true"></i> Service </a></li>
                  <!--          <li><a href="https://ehostingguru.com/stage/valogical/admin/payment"><i class="fa fa-circle-o" aria-hidden="true"></i>Complete Payment </a></li>-->
                </ul>
              </li>
              ...
              <li class="sub-menu dcjq-parent-li">
                <a href="javascript:;" class="dcjq-parent">
                  <i class="fa fa-tasks" aria-hidden="true"></i> <span>Task Management</span>
                  <i class="fa fa-angle-down iconright" aria-hidden="true"></i>
                  <span class="dcjq-icon"></span></a>
                <ul class="sub" style="display: none;">
                  <li><a href="<?= base_url('admin/task') ?>"><i class="fa fa-circle-o" aria-hidden="true"></i> Task </a></li>
                  <!--          <li><a href="https://ehostingguru.com/stage/valogical/admin/payment"><i class="fa fa-circle-o" aria-hidden="true"></i>Complete Payment </a></li>-->
                </ul>
              </li>
            </ul>
          ...
          <div class="leftside-navigation">
            <?php if (1 == 2) { ?>
              <ul class="sidebar-menu" id="nav-accordion">
                ...
                // echo $child_menu_id_array['0'];die();
                /*echo "<pre>";
	  	          print_r($child_menu_id_array);die();*/
            ...
            <ul class="sidebar-menu" id="nav-accordion">
              <li>
                <a href="https://ehostingguru.com/stage/valogical/admin/supervisorr">
                  <i class="fa fa-dashboard"></i>
                  <span>Dashboard</span>
                </a>
              </li>
              <li class="sub-menu dcjq-parent-li">
                <a href="javascript:;" class="dcjq-parent">
                  ...
                  <span class="dcjq-icon"></span></a>
                <ul class="sub" style="display: none;">
                  <li><a href="https://ehostingguru.com/stage/valogical/admin/supervisorr/task"><i class="fa fa-circle-o" aria-hidden="true"></i> Task</a></li>
                </ul>
              </li>
              <li class="sub-menu dcjq-parent-li">
                <a href="javascript:;" class="dcjq-parent">
                  ...
                  <span class="dcjq-icon"></span></a>
                <ul class="sub" style="display: none;">
                  <li><a href="https://ehostingguru.com/stage/valogical/admin/customer"><i class="fa fa-circle-o" aria-hidden="true"></i> Customer </a></li>
                  <!--          <li><a href="https://ehostingguru.com/stage/valogical/admin/payment"><i class="fa fa-circle-o" aria-hidden="true"></i>Complete Payment </a></li>-->
                </ul>
              </li>
              <li class="sub-menu dcjq-parent-li">
                <a href="javascript:;" class="dcjq-parent">
                  ...
                  <span class="dcjq-icon"></span></a>
                <ul class="sub" style="display: none;">
                  <li><a href="https://ehostingguru.com/stage/valogical/admin/service"><i class="fa fa-circle-o" aria-hidden="true"></i> Service </a></li>
                  <!--          <li><a href="https://ehostingguru.com/stage/valogical/admin/payment"><i class="fa fa-circle-o" aria-hidden="true"></i>Complete Payment </a></li>-->
                </ul>
              </li>
              <li class="sub-menu dcjq-parent-li">
                <a href="javascript:;" class="dcjq-parent">
                  ...
                  <span class="dcjq-icon"></span></a>
                <ul class="sub" style="display: none;">
                  <li><a href="https://ehostingguru.com/stage/valogical/admin/supervisor"><i class="fa fa-circle-o" aria-hidden="true"></i> Supervisor </a></li>
                  <!--          <li><a href="https://ehostingguru.com/stage/valogical/admin/payment"><i class="fa fa-circle-o" aria-hidden="true"></i>Complete Payment </a></li>-->
                  <li><a href="https://ehostingguru.com/stage/valogical/admin/employee"><i class="fa fa-circle-o" aria-hidden="true"></i> Employee </a></li>
                  <!--          <li><a href="https://ehostingguru.com/stage/valogical/admin/payment"><i class="fa fa-circle-o" aria-hidden="true"></i>Complete Payment </a></li>-->
                </ul>
              </li>
            </ul>
