				...
				<section class="panel">
					...
					<div class="panel-body">
						...
						<div>
							...
							<form role="form" method="POST" id="c_form" action="" autocomplete="off" enctype="multipart/form-data">
									...
									<div class="tab-content">
										...
										<div id="home" class="tab-pane fade in active">
											...
											<div class="form-group">
												...
												<input name="service_name" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))" type="text" class="form-control" placeholder="Enter Service Name*" value="<?php echo set_value('service_name'); ?>">
