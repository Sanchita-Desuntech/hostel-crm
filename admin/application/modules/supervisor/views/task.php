                        ...
                        <div class="adv-table editable-table ">
                            ...
                            <table class="table table-striped table-bordered nowrap" id="tabledata" style="width:100%;">
                                ...
                                <td><?php echo $i;?></td>
                                    ...
                                    <td><?php 
                                    foreach($allemployee_name as $emp_name){
                                    	echo $emp_name->full_name.' ';	
                                    }
                                     ?></td>
                                    
                                    <td class="img_data">
                                    	<?php if($alldata->attach_file != '' || $alldata->attach_file != null){?>
                                    	<a target="_blank" href="<?php echo base_url();?>uploads/task/<?php echo $alldata->attach_file; ?>">view attachment</a>
                                    	<?php }else{ ?>
                                    ...
                                    <?php if($alldata->task_status != 'Completed'){?>
										<a href="<?php echo base_url();?>admin/supervisor/chat/<?php echo $alldata->task_id;?>" title="Chat"><i class='fa fa-comments' style='font-size:36px'></i></a>
										<?php }else{ ?>
