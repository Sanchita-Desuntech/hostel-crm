				  ...
				  <?php echo validation_errors(); ?>
                    ...
                    <section class="panel">
                        ...
                        <header class="panel-heading">
                           ...
                           <h3> Task Conversation <a href="<?php echo base_url();?>admin/employee" class="btn btn-danger flotright">Back</a></h3>
                        			...
                        			<div class="panel-body">
                                     ...
                                     <div class="tab-content">
                                		...
                                		<div class="form-group">
		                                    ...
		                                    <?php echo mb_strimwidth($singledata->task_desp, 0, 100, '...'); ?>

		                                </div>
										
										<div class="form-group">

		                                    <label for="inputslidercaption3">Expected Time to Compelete</label><br>

		                                    <?php echo $singledata->task_hours; ?>
		                            ...
		                            <div class="col-md-12" id="chatSection">
						              ...
						              <div class="box box-warning direct-chat direct-chat-primary">
						                ...
						                <div class="box-footer">
						                  <form role="form" id="contactForm" method="POST" action="<?php echo base_url();?>admin/supervisor/msgsend" enctype="multipart/form-data">
						                  <div class="input-group">
						                     <input type="hidden" name="send_user_id" id="send_user_id" value=<?php echo $current_my_code;?>>
