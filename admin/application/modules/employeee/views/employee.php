<?php
/*echo "<pre>";
print_r($allemployee_assigned_task);die();*/
?>
                      ...
                      <?php } ?>
                        <div class="adv-table editable-table ">
                            ...
                            <table class="table table-striped table-bordered nowrap" id="tabledata" style="width:100%;">
								...
								<?php 
								 $i=1;
								 foreach($allemployee_assigned_task as $alldata) { ?>
                                <tr class="">
                                <td><?php echo $i;?></td>
                                     <td> <a href="<?php echo base_url()?>admin/employeee/viewtask/<?php echo $alldata->task_id;?>"> <?php echo $alldata->task_name; ?> </a> </td>
                                     <td> <a href="<?php echo base_url()?>admin/employeee/viewtask/<?php echo $alldata->task_id;?>"> <?php echo mb_strimwidth($alldata->task_desp, 0, 100, '...'); ?> </a> </td>
                                    <td> <a href="<?php echo base_url()?>admin/employeee/viewtask/<?php echo $alldata->task_id;?>"> <?php echo $alldata->task_priority; ?> </a> </td>
                                    <td> <a href="<?php echo base_url()?>admin/employeee/viewtask/<?php echo $alldata->task_id;?>">  <?php echo $alldata->sup_name; ?> </a>  </td>
                    	 ...
                    	 <div class="adv-table editable-table ">
                            ...
                            <h3>All Urgent Tasks</h3>
                            <table class="table table-striped table-bordered nowrap" id="tabledata3" style="width:100%;">
                                <thead>
                                <tr>
                                	 <th>SL No.</th>
                                     <th>Task Name</th>
								...
								<?php 
								 $i=1;
								 foreach($urgent_task as $alldata) { ?>
                                <tr class="">
                                <td><?php echo $i;?></td>
                                     <td> <a href="<?php echo base_url()?>admin/employeee/viewtask/<?php echo $alldata->task_id;?>">  <?php echo $alldata->task_name; ?></a> </td>
                                     <td> <a href="<?php echo base_url()?>admin/employeee/viewtask/<?php echo $alldata->task_id;?>"> <?php echo mb_strimwidth($alldata->task_desp, 0, 100, '...'); ?> </a> </td>
