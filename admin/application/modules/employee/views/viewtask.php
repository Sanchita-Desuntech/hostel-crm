                        ...
                        <div class="adv-table editable-table ">
                            ...
                            <table class="table table-striped table-bordered nowrap" id="tabledata" style="width:100%;">
                                ...
                                <td><?php echo $i;?></td>
                                    ...
                                    <td>
                                    <a class="edit_data" href="<?php echo base_url();?>admin/task/edittask/<?php echo $alldata->id;?>"><i class="fa fa-edit"></i></a> &nbsp; 
...
<script type="text/javascript">
  function myJsFunc_comdel(dataid)
  {
    ...
    {
    window.location.href = "<?php echo base_url()?>admin/task/delete_data/"+dataid;
    }
  }
</script> 
