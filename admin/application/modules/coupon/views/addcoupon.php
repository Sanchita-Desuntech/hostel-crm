                            ...
                            <form role="form" method="POST" action="" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div id="time1" style="display: none;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="inputslidercaption">Time Addition(Hour) *</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="inputslidercaption">Coupon Description</label>
                                    <textarea name="coupon_desp" class="form-control editor_big" placeholder="Enter Coupon Description" id="coupon_desp" aria-hidden="true"><?php echo set_value('coupon_desp'); ?></textarea>
                                </div>
