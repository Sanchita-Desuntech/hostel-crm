                        ...
                        <div class="adv-table editable-table ">
                            ...
                            <table class="table table-striped table-bordered nowrap" id="tabledata" style="width:100%;">
                                ...
                                <td><?php echo $i;?></td>
                                    ...
                                    <td><?php echo $alldata->time_wallet; ?></td>
                                    <td><?php echo $alldata->remain_time; ?></td>
                                    ...
                                    <a href="<?php echo base_url();?>admin/customer/active/<?php echo $alldata->cust_code;?>" class="btn btn-danger">Inactive </a>
                                     <?php } else if($alldata->status=="1"){?>
                                       <a href="<?php echo base_url();?>admin/customer/inactive/<?php echo $alldata->cust_code;?>" class="btn btn-success">Active </a>
                                     <?php } ?>
                                       
                                    </td>
                                    <td>
                                    <a class="edit_data" href="<?php echo base_url();?>admin/customer/editcustomer/<?php echo $alldata->cust_code;?>"><i class="fa fa-edit"></i></a> &nbsp; 
                                    <a class="delete_data" onclick="myJsFunc_comdel('<?php echo $alldata->cust_code;?>','<?php echo base64_encode($alldata->profile_photo);?>') " href="javascript:void(0);"><i class="fa fa-times"></i></a>
                                    </td>
