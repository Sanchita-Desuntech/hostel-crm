  			...
  			<?php } ?>
                    <section class="panel">
                        <header class="panel-heading">
                           <h3> Edit Employee <a href="<?php echo base_url();?>admin/employee" class="btn btn-danger flotright">Back</a></h3>
                        </header>
                                		...
                                		<div class="form-group">
		                                    ...
		                                    <select name="supervisor_name" class="form-control">
		                                    	<option value="">Select Option</option>
													...
													<option value=<?php echo $res_supervisor->sup_code;?> <?php if($res_supervisor->sup_code== $singledata->supervisor_name) {echo "selected"; } ?>><?php echo $res_supervisor->full_name;?></option>
												<?php }?>                          	
		                                    </select>
