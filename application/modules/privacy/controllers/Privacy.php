...
class Privacy extends MX_Controller
{
    ...
    {
    	$data['recipe_category_data']= $this->Privacy_model->get_recipe_category_data();
		
        $data['pages_data']= $this->Privacy_model->get_pages_data();
		
       
        $data['pages_data'] = $this->Privacy_model->get_sng_pages_data();
        ...
        $this->template->build('privacy',$data);
    }
