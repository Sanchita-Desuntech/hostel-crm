...
class Democlass extends MX_Controller
{
    public function __construct()
    {
        parent::__construct();
       $this->load->model('Democlass_model'); 
    }
    //===================================================================
    public function index()
    {
		
        $data['pages_data']= $this->Democlass_model->get_pages_data();
		
       
        $data['pages_data'] = $this->Democlass_model->get_sng_pages_data();

        $data['address_data']= $this->Democlass_model->get_address_data();
		
			$data['center_data']= $this->Democlass_model->get_center_data();
        ...
        $this->template->build('democlass',$data);
    }
