...
class Feediscount extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $data['pages_data']= $this->Feediscount_model->get_pages_data();
		
       
        $data['pages_data'] = $this->Feediscount_model->get_sng_pages_data();

        $data['address_data']= $this->Feediscount_model->get_address_data();
		
		$data['center_data']= $this->Feediscount_model->get_center_data();
        ...
        $this->template->build('feediscount',$data);
    }
