...
<br />
                                    ...
                                    <h4 class="fbtl">Student Feedback</h4>

									<div class="row">

										<div class="col-lg-3 col-sm-3 col-xs-12">

										<h3 class="pri-post-date">
                ...
                <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"  style="width:10%;">
                   ...
                   1 <i class="fa fa-star"></i>
                                        ...
                                        <?php if($single_comment->status==1){?>
											...
											<div class="single-review">
												...
												<div class="author-image">
													...
													<img src="http://graph.facebook.com/<?=$single_comment->profile_image?>/picture?type=normal" alt="">
                                        ...
                                        <div class="col-lg-12">
                                         ...
                                         <div class="form-group"> <textarea required class="form-control" name="comment" placeholder="Your Message" id="face_message" rows="5"></textarea> </div>
				...
				<div class="col-md-4 col-sm-12">
					...
					<div class="single-course-sidebar">
						...
						<div class="sidebar-widget">
                            ...
                            <?php foreach($get_latest_course_data as $latest_crs){?>
								...
								<div class="sidebar-course-single">
									...
									<div class="course-image">
										...
										<img src="<?php echo base_url();?>uploads/courses_image/<?php echo $latest_crs->image_src;?>" alt="<?php echo strip_tags($latest_crs->course_name);?>" width="100" >

									</div>

									<div class="course-prefix">

										<h4><a href="<?php echo base_url();?>course/<?php echo $latest_crs->course_slug;?>"><?php echo $latest_crs->course_name;?></a></h4>

									<a href="<?php echo base_url();?>course/<?php echo $latest_crs->course_slug;?>" class="feesread"><?php echo $latest_crs->course_fees;?></a>	
...

		{
			  ...
			  $.ajax({
				  ...
				  url:"<?php echo base_url(); ?>" + "courses/submit_msg ",
				   ...
				   data:{course_id:course_id,email:face_email,name:face_name,profile_image:face_image,url:course_url,comment:face_message,rating:rating_hidden},
