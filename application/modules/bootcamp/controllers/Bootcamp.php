...
class Bootcamp extends MX_Controller
{
    ...
    public function index()
    {
		...
		$data['pages_data']= $this->Bootcamp_model->get_pages_data();
		$data['client_data']= $this->Bootcamp_model->get_client_logo();
       
       // $data['pages_data'] = $this->Bootcamp_model->get_sng_pages_data();
        ...
        $this->template->build('bootcamp',$data);
    }
