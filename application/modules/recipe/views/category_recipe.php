				...
				<section class="content three-fourth">
					...
					<div class="entries row">
						...
						<?php foreach($recipe_data as $res_rcp) {
								$jsonDecode=json_decode($res_rcp->category);
								//print_r($jsonDecode);
								if(in_array($category_data['category']->id,$jsonDecode)){
						...
						<div class="entry one-third">
							...
							<div class="container">
								...
								<div class="actions">
									<div>
										<div class="difficulty"><i class="ico i-medium"></i><a href="#"><?php echo $res_rcp->diff_name;?></a></div>
					...
					<!--//entries-->
					<div class="ads1"><img src="<?php echo base_url()?>img/ads-1.png" alt=""/></div>
				</section>
				<!--//content-->
