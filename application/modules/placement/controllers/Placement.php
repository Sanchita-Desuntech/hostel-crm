...
class Placement extends MX_Controller
{
    ...
    public function index()
    {
	    ...
	    $data['pages_data'] = $this->Placement_model->get_sng_pages_data();
		
		$data['get_client_logo'] = $this->Placement_model->get_client_logo();


		$data['get_placement_data'] = $this->Placement_model->get_all_placement_data();
        ...
        $this->template->build('placement',$data);	
